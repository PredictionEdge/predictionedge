      ...
      <div className="flex items-center justify-between mb-4 gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] text-muted-foreground/40">{lastRefresh.toLocaleTimeString()}</span>
          </div>
          ...
          <div key={arb.id}
            ...
            <div className="px-5 py-4 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                {arb.category && <p className="text-[10px] text-muted-foreground/40 mb-0.5">{arb.category}</p>}
                <p className="text-sm truncate">{arb.market}</p>
                <p className="text-[10px] text-muted-foreground/40 mt-0.5 hidden sm:block">{arb.direction}</p>
              </div>

              {/* Prices */}
              <div className="flex items-center gap-5 shrink-0">
                <div className="text-right hidden sm:block">
                  <p className="text-[10px] text-[var(--color-kalshi)]/50 mb-0.5">Kalshi</p>
                ...
                <div className="text-right hidden sm:block">
                  <p className="text-[10px] text-[var(--color-poly)]/50 mb-0.5">Poly</p>
