    ...
    return (
      <div className="flex min-h-[60vh] items-center justify-center px-6 text-center">
        <div>
          ...
          <p className="text-xs text-muted-foreground/40">Confirmation link sent to {email}</p>
  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <p className="text-xs text-muted-foreground/40 mb-8">Start finding opportunities</p>
        ...
        <div className="my-6 flex items-center gap-3">
          <Separator className="flex-1 bg-border/30" /><span className="text-[10px] text-muted-foreground/20">or</span><Separator className="flex-1 bg-border/30" />
        </div>
